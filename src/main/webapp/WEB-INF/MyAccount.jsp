...
<div class="wrapper">
   ...
   <br>
   <br>
   <form action="/change-password/update">
   Old Password : <input type="password" id="old" name="old" required/><br>
   New Password : <input type="password" id="new1" name="new1" required/><br>
   New Password : <input type="password" id="new2" name="new2" required/><br>
